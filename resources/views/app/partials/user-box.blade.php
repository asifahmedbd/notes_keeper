<div class="user-box text-center">
  <img src="/images/users/{{ Auth::user()->user_image }}" alt="user-img" title="{{ Auth::user()->name }}" class="rounded-circle avatar-md" onerror="this.onerror=null;this.src='/images/users/default_user.png';">
